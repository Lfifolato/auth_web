...
namespace auth_web.Controllers
{
    public class EscolasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,nome,cidade,contato,telefone")] escola escola)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,nome,cidade,contato,telefone")] escola escola)
        {
            if (id != escola.id)
            {
                return NotFound();
